...
{% include top-all-articles.html 
    ...
    bleue,
    donjon-potions,
    le-train-des-sorciers,
    stockholm,
    lelixir,
    lautre-demeure,
    la-mine,
    le-chemin-de-traverse,
    le-manoir-des-addams,
    karma-project,
    la-prison-romaine,
    alice,
    maudit-pirate,
    sous-les-tuiles-de-la-revolution,
    b-i-z-u,
    seven,
    mission-istanbul,
    ...
    le-fantome-du-titanic,
    le-syndicat-du-crime-chapitre-1-otages,
    mib-mission-is-back,
    le-secret-de-la-liqueur-verte,
    20-000-ans-sous-la-terre-chapitre-ii,
