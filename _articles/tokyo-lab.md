...
# Une cohérence impeccable, un final bluffant
La grande force de Tokyo Lab, c’est sa cohérence. La salle ne perd jamais de vue l’objectif initial : s’introduire dans le laboratoire tokyoïte suspecté d’être à l’origine de la propagation d’un virus mortel et tout faire pour empêcher la catastrophe. Logiquement, vos actions suivent cette trame scénaristique. Après une phase d’infiltration centrée sur la fouille, l’observation et l’action, l’aventure prend une tournure plus réflexive, davantage guidée, et surtout axée sur des protocoles scientifiques. 

Sur le plan du contenu, les énigmes sont donc très variées et offrent même la possibilité de se répartir les tâches dans la seconde partie de la salle. Les grands groupes peuvent alors évoluer dans des conditions optimales. Au cours du jeu, la difficulté augmente progressivement et atteint un niveau relativement ardu en ce qui concerne les dernières manipulations à effectuer.

L’introduction marque les esprits. Que dire du final bluffant qui vous attend… Saisissant de réalisme, il suscite l’effroi puis la joie si vous arrivez à remplir votre mission. L’effet spécial employé, rare dans le milieu des escape game mais répandu dans les parcs à thème, permet à Tokyo Lab de boxer dans la catégorie des salles à grand spectacle.
